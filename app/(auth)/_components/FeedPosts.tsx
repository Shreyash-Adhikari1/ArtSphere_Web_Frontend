...
export default function FeedPosts({
  ...
  if (posts.length === 0) {
    return <div className="text-gray-400 italic">No posts yet.</div>;
  }
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <div
                ...
                onClick={() => {
                  if (post.author?._id) router.push(`/user/${post.author._id}`);
                }}
              >
                <img
                  src={avatarUrl}
            ...
            {post.caption && (
              <p className="text-black font-medium mb-4">{post.caption}</p>
            )}
